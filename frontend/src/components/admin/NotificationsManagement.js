...
const NotificationsManagement = () => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-8"> Notification/Newsletter Management</h2>
      <div className="px-4 py-4 bg-white shadow-lg rounded-2xl">

        {/*Creat New Notification */}
        <div>
          <div className="mb-6 pt-2">
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-3 rounded-lg shadow-md mb-8">
              <h3 className="text-lg font-semibold text-white">Create New Notification</h3>
            </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-3 rounded-lg shadow-md mb-8">
          <h3 className="text-lg font-semibold text-white"> Manage Created Notifications</h3>
        </div>
