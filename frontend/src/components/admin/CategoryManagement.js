...
const CategoryManagement = ({ 
  ...
  setActiveMenu,
   ...
   // Import React's useEffect hook at the top level of your file
   const { useEffect } = React;
   // Initialize showEditForm to false to show the list of categories by default
   const [showEditForm, setShowEditForm] = useState(false);

  // Function to switch to Add Category mode
        ...
        <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 rounded-lg shadow">
          {isEdit && (
            <div className="flex justify-between items-center mb-4">
              <h4 className="text-lg font-medium">{formData._id ? 'Update' : 'Add'} Category</h4>
          ...
          <button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
            {formData._id ? 'Update' : 'Add'} Category
          </button>
        </form>
      )}
    </div>
...
// // work well but sepeate edit and add
// // src/components/admin/CategoryManagement.js
// import React, { useState } from 'react';
// import axios from 'axios';
// import { PaginatedList } from './PaginatedList';
