...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If it's an email error, focus the email input
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-md p-8" style={{marginTop: 50+'px', marginBottom: 30+'px'}}>
