  ...
  return (
    <div className="bg-gray-50 min-h-screen" >
      ...
      <div className="mt-12 bg-gray-200 rounded-xl overflow-hidden shadow-lg" style={{ padding: 0, margin: 0 }}>
        <iframe 
          title="Bag&Box Location"
          src={`https://www.google.com/maps/embed/v1/place?key=${googleMapsApiKey}&q=${encodeURIComponent("102-1127 14th St W, North Vancouver, BC, V7P 1J9")}`}
          width="100%" 
          height="400" 
          frameBorder="0" 
          style={{ border: 0 }}
