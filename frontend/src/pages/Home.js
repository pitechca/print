// working with new diesgn but no animation
// src/pages/Home.js
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('${window.innerWidth < 768 ? '/images/s3.jpg' : '/images/s1.jpg'}')`,
              ...
              <div className="w-full md:w-2/3">
                {selectedCategory ? (
                  <>
                    ...
                    <div key={selectedCategory} className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 fade-in">
                      {products
                        .filter(product =>
                ...
                <div key={category._id}>
                  ...
                  <div
                    id={`category-${category._id}`}
                       onClick={() => {
                        if (window.innerWidth < 768) {
                               ...
                               setTimeout(() => {
                                 ...
                                 setTimeout(() => {
                                   document.getElementById(`category-${category._id}`)?.scrollIntoView({ behavior: 'smooth', block: 'start' });
                                 }, 100);
                           }, 500);
                         } else {
                           setSelectedCategory(category._id);
                       ...
                       className={`flex items-center p-4 border border-gray-200 cursor-pointer hover:bg-gray-300 ${ selectedCategory === category._id ? 'bg-blue-500' : '' }`}
                     >
