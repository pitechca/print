...
//         if (selectedItem) {
//           console.log('Updating product:', selectedItem._id, productData);
//           response = await axios.put(
//             `/api/products/${selectedItem._id}`,
//             productData,
//             { headers }
//           );
//           successMessage = 'Product updated successfully!';
...
//       console.log('Editable product:', editableProduct);
//       setSelectedItem(item);
//       setFormData(prev => ({ ...prev, [type]: editableProduct }));
//       setActiveMenu(`edit${type.charAt(0).toUpperCase() + type.slice(1)}`);
//       return;
...
//    // Memoize SidebarItem but keep it within the component
//    const SidebarItem = React.memo(({ label, menu, icon}) => (
//     <button
//       onClick={() => setActiveMenu(menu)}
//       className={`w-full flex items-center justify-start text-left px-4 py-2 space-x-2 ${
...
//       console.log('Editable product:', editableProduct); // Debug log
//       setSelectedItem(item);
//       setFormData(prev => ({ ...prev, [type]: editableProduct }));
//       setActiveMenu(`edit${type.charAt(0).toUpperCase() + type.slice(1)}`);
//       return;
